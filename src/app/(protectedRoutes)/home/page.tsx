...
const Pages = (props: Props) => {
  ...
  return (
    <div className="w-full mx-auto h-full ">
      <div className="w-full flex flex-col sm:flex-row justify-between items-startgap-14">
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6 rounded-xl bg-background-10">
        <FeatureSectionLayout
          ...
          link="/lead"
        >
          <div className="p-5 flex flex-col gap-4 items-center border border-border rounded-xl backdrop-blur-3xl">
        ...
        >
          <div className="flex gap-4 items-center h-full w-full justify-center relative flex-wrap">
            ...
            <Image
              ...
              width={350}
              height={350}
              className="object-cover rounded-xl absolut mb-28 px-5 hidden sm:flex  backdrop-blur-[20px]"
            />
          </div>
        </FeatureSectionLayout>
      </div>
